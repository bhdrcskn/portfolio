...
const socials = [ 
 { 
   icon: faGithub, 
   url: "https://www.github.com/bhdrcskn", 
 }, 
 { 
   icon: faLinkedin, 
   url: "https://www.linkedin.com/in/bahadir-coskun/", 
 }, 
 { 
   icon: faMedium, 
   url: "https://medium.com/@bahadircoskun", 
 }
]; 
   ...
   > 
     <Box color="white" maxWidth="1280px" margin="0 auto"> 
       ...
       > 
         ...
         <nav> 
           <HStack spacing={8}> 
             <a href="#featured-projects" onClick={handleClick("projects")}> 
             Featured Projects 
             </a>  
           </HStack> 
         </nav> 
